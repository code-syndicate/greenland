...
from users.models import User
from banking.models import TransferRequest,BankAccount,OTP
from banking.admin import TransferRequestAdmin,BankAccountAdmin,OTPAdmin
...
admin_site1.register(OTP, OTPAdmin)
